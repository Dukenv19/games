// 盤面一覧
const qboards = [
    "12 1"+"32 3"+" 4  "+"1  1"+"_11_",
    "2 2 "+"14 1"+"3  3"+" 11 "+"1__1", 
    "14 1"+"3  3"+" 11 "+"3113"+" __ ",
    "34 1"+"   1"+"32 3"+" 13 "+"_1 _",
    "14 1"+"1  1"+"332 "+"  2 "+"_2 _",
    "34 3"+"    "+"1111"+"2 2 "+"1__1",
...
window.onload = () => {
    ...
    const printb = (b, scale) =>
    {
        ...
        return '<div class="board">' + b.split("").map((c, pos) => {
            ...
            var size = {
                ...
                2: {w:2, h:1, c:"url('img/p2.png')"},
                3: {w:1, h:2, c:"url('img/p3.png')"},
                4: {w:2, h:2, c:"url('img/stego.png')"},
            };
            ...
            style.push("background:" + size[c].c);
    ...
    const show_menu = function() {
        $id("menu").innerHTML = "<h2> Select Level : Easy > Medium > Hard </h2>";
        qboards.forEach((b,i) => {
